...
# rofi -modi window -show window -config $HOME/.config/rofi/windows.rasi
number='^[0-9]+$'
...
result=$(echo -e "$options" | rofi -dmenu -config $HOME/.config/rofi/windows.rasi -i -format i -p "window:")
